...
describe('HeapSort', () => {
  it("heap sort should throw an error when the custom comparator doesn't return -1, 1, or 0", () => {
    ...
    // Error
    assert.throws(() => { heapSort(arr, wrongNegativeComp); }, Error);
    assert.throws(() => { heapSort(arr, wrongPositiveComp); }, Error);
  });
  ...
  it('heap sort should, without a comparator, sort an array in ascending order', () => {
