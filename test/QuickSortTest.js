...
describe('QuickSort', () => {
  it("quick sort should throw an error when the custom comparator doesn't return -1, 1, or 0", () => {
    ...
    // Error
    assert.throws(() => { quickSort(arr, wrongNegativeComp); }, Error);
    assert.throws(() => { quickSort(arr, wrongPositiveComp); }, Error);
  });
