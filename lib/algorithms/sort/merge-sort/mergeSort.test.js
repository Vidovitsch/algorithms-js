...
describe('MergeSort', () => {
    it('merge sort should throw an error when the custom comparator doesn\'t return a number', () => {
        ...
        // Asserts: Error
        assert.throws(() => { mergeSort(arr, wrongComp1); }, Error);
        assert.throws(() => { mergeSort(arr, wrongComp2); }, Error);
    });
