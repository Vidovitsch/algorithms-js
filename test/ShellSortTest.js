...
describe('ShellSort', () => {
  it("shell sort should throw an error when the custom comparator doesn't return -1, 1, or 0", () => {
    ...
    // Error
    assert.throws(() => { shellSort(arr, wrongNegativeComp); }, Error);
    assert.throws(() => { shellSort(arr, wrongPositiveComp); }, Error);
  });
